<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="addtocart.aspx.cs" Inherits="Admin_addtocart" %>
...
<center>
    <div class="col-lg-8 mx-auto col-11">
     <h1 class="hero-title text-center mb-5">Add To Cart Master</h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [addtocart]"></asp:SqlDataSource>
        <br />
        <br />
</asp:Content>
