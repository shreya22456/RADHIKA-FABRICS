<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="loginedit.aspx.cs" Inherits="Admin_loginedit" %>
...
<center>
    <div class="col-lg-8 mx-auto col-11">
     <h1 class="hero-title text-center mb-5">Login Edit</h1>
   ...
   <div class="col-lg-9 col-14 mx-auto">
    ...
    <asp:Button ID="btnloginedit" runat="server" Text="Update" 
        onclick="btnloginedit_Click" BorderColor="Black" 
